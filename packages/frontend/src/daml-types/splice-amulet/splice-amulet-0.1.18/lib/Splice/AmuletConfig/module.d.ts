...
export declare type AmuletConfig<unit> = {
  ...
  externalPartyConfigStateTickDuration: damlTypes.Optional<pkgb70db8369e1c461d5c70f1c86f526a29e9776c655e6ffc2560f95b05ccb8b946.DA.Time.Types.RelTime>;
};
...
export declare type TransferConfigV2<unit> = {
...
export declare const TransferConfigV2 :
  (<unit>(unit: damlTypes.Serializable<unit>) => damlTypes.Serializable<TransferConfigV2<unit>>) & {
};

...
import * as Splice_AmuletAllocation from '../../Splice/AmuletAllocation/module';
...
export declare type ExternalPartyAmuletRules_ExpireAmuletAllocations = {
  expectedDso: damlTypes.Party;
  inputs: ExternalPartyAmuletRules_ExpireAmuletAllocationInput[];
  observers: damlTypes.Party[];
};

export declare const ExternalPartyAmuletRules_ExpireAmuletAllocations:
  damlTypes.Serializable<ExternalPartyAmuletRules_ExpireAmuletAllocations> & {
  }
;
...
export declare interface ExternalPartyAmuletRulesInterface {
  ExternalPartyAmuletRules_ExpireAmuletAllocations: damlTypes.Choice<ExternalPartyAmuletRules, ExternalPartyAmuletRules_ExpireAmuletAllocations, ExternalPartyAmuletRules_ExpireAmuletAllocationsResult, undefined> & damlTypes.ChoiceFrom<damlTypes.Template<ExternalPartyAmuletRules, undefined>>;
...
export declare type ExternalPartyAmuletRules_ExpireAmuletAllocationsResult = {
  results: Splice_AmuletAllocation.AmuletAllocation_DsoExpireResult[];
};

export declare const ExternalPartyAmuletRules_ExpireAmuletAllocationsResult:
  damlTypes.Serializable<ExternalPartyAmuletRules_ExpireAmuletAllocationsResult> & {
  }
;


export declare type ExternalPartyAmuletRules_ExpireAmuletAllocationInput = {
  allocationCid: damlTypes.ContractId<Splice_AmuletAllocation.AmuletAllocation>;
  expireLock: boolean;
};

export declare const ExternalPartyAmuletRules_ExpireAmuletAllocationInput:
  damlTypes.Serializable<ExternalPartyAmuletRules_ExpireAmuletAllocationInput> & {
  }
;

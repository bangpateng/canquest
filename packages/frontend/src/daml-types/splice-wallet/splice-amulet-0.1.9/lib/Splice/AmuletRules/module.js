...
exports.TransferPreapproval = damlTypes.assembleTemplate(
{
  ...
  templateIdWithPackageId: 'a5b055492fb8f08b2e7bc0fc94da6da50c39c2e1d7f24cd5ea8db12fc87c1332:Splice.AmuletRules:TransferPreapproval',
...
damlTypes.registerTemplate(exports.TransferPreapproval, ['a5b055492fb8f08b2e7bc0fc94da6da50c39c2e1d7f24cd5ea8db12fc87c1332', '#splice-amulet']);
...
exports.ExternalPartySetupProposal = damlTypes.assembleTemplate(
{
  ...
  templateIdWithPackageId: 'a5b055492fb8f08b2e7bc0fc94da6da50c39c2e1d7f24cd5ea8db12fc87c1332:Splice.AmuletRules:ExternalPartySetupProposal',
  keyDecoder: damlTypes.lazyMemo(function () { return jtv.constant(undefined); }),
  keyEncode: function () { throw 'EncodeError'; },
...
damlTypes.registerTemplate(exports.ExternalPartySetupProposal, ['a5b055492fb8f08b2e7bc0fc94da6da50c39c2e1d7f24cd5ea8db12fc87c1332', '#splice-amulet']);
...
exports.AmuletRules_ConvertFeaturedAppActivityMarkers = {
  decoder: damlTypes.lazyMemo(function () { return jtv.object({markerCids: damlTypes.List(damlTypes.ContractId(Splice_Amulet.FeaturedAppActivityMarker)).decoder, openMiningRoundCid: damlTypes.ContractId(Splice_Round.OpenMiningRound).decoder, }); }),
  encode: function (__typed__) {
  return {
...
exports.AmuletRules_Bootstrap_Rounds = {
  decoder: damlTypes.lazyMemo(function () { return jtv.object({amuletPrice: damlTypes.Numeric(10).decoder, round0Duration: pkgb70db8369e1c461d5c70f1c86f526a29e9776c655e6ffc2560f95b05ccb8b946.DA.Time.Types.RelTime.decoder, }); }),
  encode: function (__typed__) {
  return {
    amuletPrice: damlTypes.Numeric(10).encode(__typed__.amuletPrice),
...
exports.AmuletRules_BuyMemberTraffic = {
  decoder: damlTypes.lazyMemo(function () { return jtv.object({inputs: damlTypes.List(exports.TransferInput).decoder, context: exports.TransferContext.decoder, provider: damlTypes.Party.decoder, memberId: damlTypes.Text.decoder, synchronizerId: damlTypes.Text.decoder, migrationId: damlTypes.Int.decoder, trafficAmount: damlTypes.Int.decoder, }); }),
  encode: function (__typed__) {
  return {
    inputs: damlTypes.List(exports.TransferInput).encode(__typed__.inputs),
    context: exports.TransferContext.encode(__typed__.context),
...
exports.AmuletRules_CreateTransferPreapproval = {
  decoder: damlTypes.lazyMemo(function () { return jtv.object({context: exports.PaymentTransferContext.decoder, inputs: damlTypes.List(exports.TransferInput).decoder, receiver: damlTypes.Party.decoder, provider: damlTypes.Party.decoder, expiresAt: damlTypes.Time.decoder, }); }),
  encode: function (__typed__) {
  return {
    context: exports.PaymentTransferContext.encode(__typed__.context),
    inputs: damlTypes.List(exports.TransferInput).encode(__typed__.inputs),
...
exports.AmuletRules_CreateExternalPartySetupProposal = {
  decoder: damlTypes.lazyMemo(function () { return jtv.object({context: exports.PaymentTransferContext.decoder, inputs: damlTypes.List(exports.TransferInput).decoder, user: damlTypes.Party.decoder, validator: damlTypes.Party.decoder, preapprovalExpiresAt: damlTypes.Time.decoder, }); }),
  encode: function (__typed__) {
  return {
    context: exports.PaymentTransferContext.encode(__typed__.context),
    inputs: damlTypes.List(exports.TransferInput).encode(__typed__.inputs),
...
exports.AmuletRules_Transfer = {
  decoder: damlTypes.lazyMemo(function () { return jtv.object({transfer: exports.Transfer.decoder, context: exports.TransferContext.decoder, }); }),
  encode: function (__typed__) {
  return {
...
exports.AmuletRules_ComputeFees = {
  decoder: damlTypes.lazyMemo(function () { return jtv.object({context: exports.TransferContext.decoder, sender: damlTypes.Party.decoder, outputs: damlTypes.List(exports.TransferOutput).decoder, }); }),
  encode: function (__typed__) {
  return {
    context: exports.TransferContext.encode(__typed__.context),
    sender: damlTypes.Party.encode(__typed__.sender),
...
exports.AmuletRules = damlTypes.assembleTemplate(
{
  ...
  templateIdWithPackageId: 'a5b055492fb8f08b2e7bc0fc94da6da50c39c2e1d7f24cd5ea8db12fc87c1332:Splice.AmuletRules:AmuletRules',
  keyDecoder: damlTypes.lazyMemo(function () { return jtv.constant(undefined); }),
  keyEncode: function () { throw 'EncodeError'; },
...
damlTypes.registerTemplate(exports.AmuletRules, ['a5b055492fb8f08b2e7bc0fc94da6da50c39c2e1d7f24cd5ea8db12fc87c1332', '#splice-amulet']);
...
exports.AmuletRules_Bootstrap_RoundsResult = {
  decoder: damlTypes.lazyMemo(function () { return jtv.object({openMiningRoundCid: damlTypes.ContractId(Splice_Round.OpenMiningRound).decoder, }); }),
  encode: function (__typed__) {
  return {
    openMiningRoundCid: damlTypes.ContractId(Splice_Round.OpenMiningRound).encode(__typed__.openMiningRoundCid),
  };

...
module.exports = {
  apps: [
    ...
    },
    {
      ...
      env_production: {
        NODE_ENV: 'production',
        SPLICE_VALIDATOR_URL: apiEnv.SPLICE_VALIDATOR_URL ?? 'http://localhost:5012',
        SPLICE_VALIDATOR_HOST_HEADER: apiEnv.SPLICE_VALIDATOR_HOST_HEADER ?? 'wallet.localhost',
        CANTON_SPLICE_SECRET: apiEnv.CANTON_SPLICE_SECRET ?? '',
        SPLICE_BOT_USERNAME: apiEnv.SPLICE_BOT_USERNAME ?? 'administrator',
        SPLICE_BOT_AUTO_ACCEPT: apiEnv.SPLICE_BOT_AUTO_ACCEPT ?? 'true',
        SPLICE_BOT_POLL_INTERVAL_MS: apiEnv.SPLICE_BOT_POLL_INTERVAL_MS ?? '10000',
      },
      watch: false,

      ...
      <div className="mx-auto w-full max-w-lg space-y-4">
        ...
        {items.length > 0 && (
          <div className="rounded-2xl border border-[var(--border)] bg-[var(--card)] p-5">
            <h2 className="mb-3 text-[10px] font-bold uppercase tracking-widest text-[var(--muted-foreground)]">
              Prizes
            </h2>
            <div className="grid grid-cols-2 gap-2 sm:grid-cols-3">
              {items.map((item, i) => (
                <div
                  key={item.id}
                  className="flex items-center gap-2.5 rounded-xl border border-[var(--border)] bg-[var(--muted)]/20 px-3 py-2.5 transition-colors hover:bg-[var(--muted)]/40"
                >
                  <div
                    className="h-2.5 w-2.5 shrink-0 rounded-full ring-1 ring-white/20"
                    style={{
                      backgroundColor:
                        item.color && item.color !== "#6366f1"
                          ? item.color
        ...
        {history.length > 0 && (
          <div className="rounded-2xl border border-[var(--border)] bg-[var(--card)] p-5">
            <div className="mb-3 flex items-center justify-between">
              <h2 className="text-[10px] font-bold uppercase tracking-widest text-[var(--muted-foreground)]">
                Recent Spins
              </h2>
              <button
                type="button"
            ...
            <div className="space-y-2">
              {history.map((h) => (
                <div
                  key={h.id}
                  className="flex items-center justify-between gap-3 rounded-xl border border-[var(--border)] bg-[var(--muted)]/10 px-3 py-2.5"
                >
                  <div className="flex items-center gap-2.5">
                    ...
                    <div>
                      ...
                      <p className="text-[10px] text-[var(--muted-foreground)]">
                        -{h.pointsSpent} pts · {new Date(h.createdAt).toLocaleDateString()}
                      </p>
                    </div>
                  </div>
                  <span

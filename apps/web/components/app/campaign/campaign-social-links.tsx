...
function SocialIcon({
  ...
  platform: QuestSocialLink["platform"];
  className?: string;
}) {
  ...
  switch (platform) {
    ...
    case "medium":
      return (
        <svg className={cls} viewBox="0 0 24 24" fill="currentColor" aria-hidden>
          <path d="M13.54 12a6.8 6.8 0 0 1-6.77 6.82A6.8 6.8 0 0 1 0 12a6.8 6.8 0 0 1 6.77-6.82A6.8 6.8 0 0 1 13.54 12zM20.96 12c0 3.54-1.51 6.42-3.38 6.42-1.87 0-3.39-2.88-3.39-6.42s1.52-6.42 3.39-6.42 3.38 2.88 3.38 6.42zm6.82 0c0 3.17-.53 5.75-1.19 5.75-.66 0-1.19-2.58-1.19-5.75s.53-5.75 1.19-5.75C26.25 6.25 26.78 8.83 26.78 12z" />
        </svg>
      );
    case "website":
    default:
...
function platformLabel(platform: QuestSocialLink["platform"]): string {
  const labels: Record<QuestSocialLink["platform"], string> = {
    twitter: "X",
    discord: "Discord",
    telegram: "Telegram",
    website: "Website",

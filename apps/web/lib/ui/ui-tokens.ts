...
export const successBannerClass =
  "rounded-2xl border border-emerald-500/30 bg-emerald-500/10 px-4 py-3 text-sm font-medium text-[var(--success)]";

/** Banner error — dipakai claim cards & form. */
export const errorBannerClass =
  "rounded-2xl border border-red-500/30 bg-red-500/10 px-4 py-3 text-sm font-medium text-[var(--danger)]";

/** Banner info/peringatan (orange). */
export const warnBannerClass =
  "rounded-2xl border border-orange-500/30 bg-orange-500/10 px-4 py-3 text-sm font-medium text-[rgb(var(--warn-rgb))]";

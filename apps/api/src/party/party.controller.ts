...
export class PartyController {
  ...
  // CIP-0056 accept/reject kini hanya lewat POST /party/offers/accept|reject
  // (auto-detect TransferInstruction). Endpoint standalone transfer-instruction/
  // accept|reject dihapus — withdraw tetap (cancel sender-side, unik).
